...
model = pickle.load(open('code and datasets/model.pkl','rb'))
label_encoders = pickle.load(open('code and datasets/label_encoders.pkl','rb'))

destinations_df = pd.read_csv("code and datasets/Expanded_Destinations.csv")
userhistory_df = pd.read_csv("code and datasets/Final_Updated_Expanded_UserHistory.csv")
...
@app.route('/')
def video():
    return render_template('statci/video.html')
